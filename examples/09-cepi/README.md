...
- This is a demonstration script for the Academy tutorial.
- The Notification agent currently only prints to console; in a production system, it would integrate with email, SMS, or other notification services.
- Ensure your OpenAI API key has sufficient credits for LLM calls.
- The system handles JSON parsing errors from the LLM gracefully by falling back to default values.

## Troubleshooting

- If you encounter import errors, ensure all dependencies are installed.
- Check your internet connection for API polling.
- Verify your OpenAI API key is valid and has the necessary permissions.
- For logging issues, the script uses Python's logging module at INFO level.